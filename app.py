...
<title>Sagar Sofa's 3D Showroom</title>
<style>
:root{
  --accent:#000;
  --bg-color:#fff;
...
body{margin:0; padding:0; font-family:'Poppins',sans-serif; background:var(--bg-color); color:var(--text-color); overflow-x:hidden; perspective:1500px; scroll-behavior:smooth;}
...
.navbar h1{margin:0;font-size:1.3rem;color:var(--accent);font-weight:600;}
...
.card button{margin-top:12px;padding:10px 18px;background:var(--accent);color:white;border:none;border-radius:6px;cursor:pointer;font-weight:500;transition:0.3s;}
...
#three-container{width:100%;height:600px;}
</style>
</head>
<body>
...
<div class="mobile-menu" id="mobileMenu"><a href="#home">Home</a><a href="#collections">Collections</a><a href="#reviews">Reviews</a><a href="#contact">Contact</a></div>
...
<div class="card" data-aos="fade-right">
  <img src="https://raw.githubusercontent.com/username/repo/main/images/sofa1.jpg" alt="Minimalist Sofa"/>
  <h3>Minimalist Comfort</h3>
  <p>Soft, stylish, and sustainable.</p>
  <button onclick="window.open('https://wa.me/919494828592','_blank')">Get Quote</button>
</div>
<div class="card" data-aos="zoom-in-up">
  <img src="https://raw.githubusercontent.com/username/repo/main/images/sofa2.jpg" alt="Modern Chair"/>
  <h3>Scandinavian Charm</h3>
  <p>Designed for relaxation and elegance.</p>
  <button onclick="window.open('https://wa.me/919494828592','_blank')">Get Quote</button>
</div>
<div class="card" data-aos="fade-left">
  <img src="https://raw.githubusercontent.com/username/repo/main/images/table.jpg" alt="Wood Table"/>
...
<section class="parallax" style="background-image:url('https://raw.githubusercontent.com/username/repo/main/images/bg1.jpg');"></section>
...
<section class="parallax" style="background-image:url('https://raw.githubusercontent.com/username/repo/main/images/bg2.jpg');"></section>
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  hamburger.addEventListener('click', ()=>{const isShown=mobileMenu.style.display==='flex'; mobileMenu.style.display=isShown?'none':'flex';});
  ...
  const directional = new THREE.DirectionalLight(0xffffff,0.8); directional.position.set(5,10,7); scene.add
